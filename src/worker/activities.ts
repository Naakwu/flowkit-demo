import type { FlowkitActorResolver } from '@flowkit/consumer';
import type {
  ExecuteSystemStepInput,
  FlowkitActivityRegistry,
  ResolveActionContextInput,
} from '@flowkit/temporal';
import { validateRegistryRefs } from '@flowkit/core';
...
import { leaveChannels, leaveGuards, leavePolicies, leaveRules, leaveSystemSteps, leaveTemplates } from '../leave/leave.registries';
