...
# FlowKit demo mode (TILT_MODE=flowkit-k3s). Builds only the FlowKit demo
# image and wires the flowkit-* resources; the AVSEC configure_k3s() above
# remains the legacy k3s mode.
